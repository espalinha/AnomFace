...
## First Steps
The first step is program a model that can do facial recognition. Here, we will not use any optimization techniques and we will use a simple architecture CNN. This model will have name naive_approach.py and will be implemented in PyTorch
